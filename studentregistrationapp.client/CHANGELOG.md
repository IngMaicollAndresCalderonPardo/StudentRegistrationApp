...
- Create Angular project with ng: `ng new studentregistrationapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`studentregistrationapp.client.esproj`).
